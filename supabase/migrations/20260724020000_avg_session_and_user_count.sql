-- 20260724020000_avg_session_and_user_count.sql
-- KPI additions for /data: totals.avg_session_secs (mean duration of
-- sessions with at least one page view) in dashboard_overview, and
-- registered_users (public.users rows, anonymous excluded) in
-- dashboard_realtime. Everything else unchanged from v4.
