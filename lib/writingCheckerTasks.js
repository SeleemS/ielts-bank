...
function buildPages() {
  ...
  return {
    'task-2': {
      ...
      description: `Check your IELTS Writing Task 2 essay with AI: an estimated band for Task Response, Coherence and Cohesion, Lexical Resource and Grammar, with corrections. ${copy.checkerFreeLine}`,
    ...
    'task-1': {
      ...
      description: `Check your IELTS Academic Writing Task 1 report with AI: an estimated band for Task Achievement, Coherence, Lexical Resource and Grammar, with overview feedback. ${copy.checkerFreeLine}`,
    ...
    'general-training-letter': {
      ...
      description: `Check your IELTS General Training Task 1 letter with AI: an estimated band plus feedback on purpose, bullet points, tone and grammar, with corrections. ${copy.checkerFreeLine}`,
