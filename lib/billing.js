...
// SKUs and PPP
// ---------------------------------------------------------------------------
// New purchases are limited to the two plans advertised on /pricing. Annual
// and Exam Pass lookup keys remain below so existing subscriptions, historical
// webhook events, and account-only upgrades continue to map correctly.
export const CHECKOUT_SKUS = ['monthly', '6month'];
export const RECURRING_SKUS = ['monthly', '6month', 'annual'];
