...
const description =
  `IELTS Bank Pro unlocks full AI Writing feedback, Speaking scoring, live examiner practice, and timed mock tests — billed monthly, annually, or as a one-time ${EXAM_PASS_DAYS}-day Exam Pass that never renews. Every plan is covered by a 14-day money-back guarantee.`;
