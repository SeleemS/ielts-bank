...
const COPY = {
  lifetime: {
    ...
    heroFootnote: 'Free means one lifetime AI Writing sample per account. Full reports and continued scoring require Pro.',
    ...
    heroFreeLine: 'One lifetime AI Writing sample per account. Full reports and continued scoring require Pro.',
    checkerFreeLine: 'One lifetime AI Writing sample per account; full reports and continued scoring require Pro.',
  ...
  weekly: {
    ...
    heroFootnote: 'Free means one AI Writing sample every week — it refills 7 days after you use it. Full reports require Pro.',
    ...
    heroFreeLine: 'One free AI Writing sample every week. Full reports require Pro.',
    checkerFreeLine: 'You get one free Writing sample every week; full reports require Pro.',
