...
const response = await fetch('https://api.openai.com/v1/chat/completions', {
  ...
  body: JSON.stringify({
    model,
    messages: [
      { role: 'system', content: 'Write a trustworthy, specific IELTS preparation article for IELTS-Bank. It must be 1,200-1,600 words, original, current, practical and accurate. Use semantic HTML limited to p, h2, h3, ul, ol, li, strong, em and internal a links. Include worked examples and a concrete practice routine. Do not claim affiliation with IELTS owners, real leaked tests, guaranteed bands, official examiner status or unverifiable current test trends. Never call a paid feature free; the Writing checker offers one free sample score and full feedback is Premium. Link naturally to relevant /readingquestion, /listeningquestion, /writingquestion, /speakingquestion, /ielts-writing-checker, /band-calculator, /band-estimator or /mock-test pages. Return a timeless title without a year.' },
