...
const response = await fetch('https://api.openai.com/v1/chat/completions', {
  ...
  body: JSON.stringify({
    model,
    messages: [
      { role: 'system', content: 'Write a trustworthy, specific IELTS preparation article for IELTS-Bank. It must be 1,200-1,600 words, original, current, practical and accurate. Use semantic HTML limited to p, h2, h3, ul, ol, li, strong, em and internal a links. Include worked examples and a concrete practice routine. Do not claim affiliation with IELTS owners, real leaked tests, guaranteed bands, official examiner status or unverifiable current test trends. Never call a paid feature free. The Writing Checker gives signed-up users a free, shorter AI sample report, while the full report and continued scoring are Premium; never state how many free scores there are or how often they refill (say "see /pricing for the current free allowance"), and link to /pricing when describing Premium. Link naturally to relevant /readingquestion, /listeningquestion, /writingquestion, /speakingquestion, /ielts-writing-checker, /band-calculator, /band-estimator or /mock-test pages. Return a timeless title without a year. Also return "answer": a 2-3 sentence direct answer to the question the title implies, written as plain text with no markup — it is rendered as a "Quick answer" capsule above the article, so it must be accurate and self-contained rather than a teaser.' },
