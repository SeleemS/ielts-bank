...
export function loadEnv() {
  ...
  return {
    ...
    OPENAI_WRITING_MODEL: process.env.OPENAI_WRITING_MODEL || env.OPENAI_WRITING_MODEL,
    OPENAI_CONTENT_MODEL: process.env.OPENAI_CONTENT_MODEL || env.OPENAI_CONTENT_MODEL,
  };
}
