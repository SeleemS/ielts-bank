...
// ---------------------------------------------------------------------------
// Calibration block — corrects the well-documented tendency of LLMs to over-mark
// IELTS Writing (a plain Band-6 essay was previously scored 7.0 on BOTH the free
// and paid models). Adds explicit accuracy/lexical/task gates for Band 7+, a
// mark-down tie-break, and worked band anchors at the 6/7 boundary. Verified on a
// known-band calibration set (weak=5, mid=6, strong=8): MAE fell from 0.50 to
// 0.00 on gpt-5.1 and 0.17 on gpt-5.4-nano, with the mid essay reliably 6 not 7
// and no over-correction of genuine 5s and 8s.
const WRITING_CALIBRATION = `CALIBRATION — READ CAREFULLY (AI examiners are known to mark IELTS Writing too high; correct for this):
